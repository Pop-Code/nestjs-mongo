 ...
 */
export type RelationshipTypeDescriptor<Relationship extends EntityInterface> = (obj?: any) => Type<Relationship> | false
...
export interface RelationshipMetadataOptions<R extends EntityInterface> extends BaseRelationshipMetadata {
  type: RelationshipTypeDescriptor<R> | Type<R> | string
}
/**
