...
import type { EntityInterface } from '../entity/interfaces'
 ...
 * @returns
 */
export function getRelationshipMetadataList<P = any>(target: Type<P>): ChildRelationshipMetadata[] {
...
>(parent: Type<Parent>, relationshipType: Type<Child>): RelationshipCascade<Child> | undefined {
